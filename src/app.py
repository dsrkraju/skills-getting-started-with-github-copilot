...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["mateo@mergington.edu", "avery@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice shooting, teamwork, and competitive games",
    ...
    "Drama Club": {
        "description": "Develop acting skills and perform plays throughout the year",
